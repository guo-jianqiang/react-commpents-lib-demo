...
// 广度优先
export function treeForeach(tree: Array<RouteItem>, func: (node: RouteItem) => void) {
  let node,
    list = [...tree]
...
export function getTreePath(nodes: Array<RouteItem>, handler: (node: RouteItem) => {}, key = 'children') {
  nodes = !Array.isArray(nodes) ? [nodes] : [...nodes]
  let path: Array<RouteItem> = []
